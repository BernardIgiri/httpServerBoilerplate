...
// ErrorBadParams paramaters are wrong
const ErrorBadParams = "BadParams"

// ErrorUnknown unknown error
const ErrorUnknown = "Unknown"

// ErrorDuplicateEntry duplicate entry found
const ErrorDuplicateEntry = "DuplicateEntry"

// ErrorReadOnly attempting to write to read only resource
const ErrorReadOnly = "ReadOnly"
